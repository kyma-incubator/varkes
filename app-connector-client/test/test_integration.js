    ...
    describe('bundled apis', () => {
        it('apis contains schools and courses', () => {
            return request(server)
                .get('/remote/apis')
                .expect(200)
                .expect(/"provider":"schoolProvider","name":"schools","description":"Schools Webservices","labels":{"label1":"value1","type":"OpenAPI"}/)
                ...
                .expect(/"provider":"Varkes","name":"courses","description":"Courses Webservices","labels":{"type":"OpenAPI"}/)
